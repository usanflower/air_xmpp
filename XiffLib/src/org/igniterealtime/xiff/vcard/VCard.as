...
package org.igniterealtime.xiff.vcard
{
	...
	public class VCard extends EventDispatcher implements IVCard
	{
		 ...
		 */
		public static var cacheFlushInterval:Number = ( 12* 60* 60 * 1000 );
		...
		public function setDeleteCash(jid:UnescapedJID):void{
			delete cache[ jid.bareJID ]; // Force profile refresh on next view
		}
