...
package org.igniterealtime.xiff.util
{
	...
	public class DateTimeParser
	{
		 ...
		 */
		public static function time2string(time:Date, ms:Boolean = false, utc:Boolean = false):String
		{
			var value:String = '';
			if(utc){
				value = (time.getUTCHours() < 10 ? "0" : "") + time.getUTCHours() + ":";
			}else{
				value = (time.getHours() < 10 ? "0" : "") + time.getHours() + ":";
			}
